...
<body id="user">
  ...
  <div class="user-container">
    ...
    <ul class="nav nav-pills nav-fill">
      <li class="nav-item">
        <a class="nav-link {{ request()->is(getURLPath(route('user.profile'))) ? 'active' : '' }}" href="{{ route('user.profile') }}">
          <i class="fa fa-fw fa-user"></i>
          <span class="nav-text">Profile</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ request()->is(getURLPath(route('user.notifications'))) ? 'active' : '' }}" href="{{ route('user.notifications') }}">
