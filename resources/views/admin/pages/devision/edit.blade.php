  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-4 col-12">
        <div class="card">
          <div class="card-body">
            <form action="{{ route('devision.update', ['id' => $devision->id]) }}" method="post">
              @csrf @method('put')
              <div class="form-group">
                <label for="name">Name:</label>
                <input type="text" value="{{ $devision->name }}" id="name" name="name" class="form-control">
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="{{ route('devision.program.update', ['devision_id' => $devision->id, 'program_id' => $program->id]) }}" method="post">
                          @csrf
                          <div class="form-group">
...
<div class="modal fade" id="addProgram" tabindex="-1" aria-labelledby="addProgramLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ route('devision.program.store', ['devision_id' => $devision->id]) }}" method="post">
          @csrf
          <div class="form-group">
            <label for="">Nama</label>
